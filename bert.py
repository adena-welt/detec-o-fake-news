...
Original file is located at
    https://colab.research.google.com/drive/1qGC9-HC9jYLYSnmtkpKqv79EoSX1Eyaz
"""
...
tokenizer_save_path = 'modelos_bert/'
tokenizer.save_pretrained(tokenizer_save_path)

# Compactar a pasta do tokenizador
import shutil
shutil.make_archive('modelos_bert', 'zip', tokenizer_save_path)

# Baixar o arquivo compactado
files.download('modelos_bert.zip')